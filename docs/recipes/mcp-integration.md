...
URL: https://portdeveloper.github.io/copy-page-button-showcase/docs/recipes/mcp-integration
...
The MCP entries are translatable via the same i18n IDs documented in [Localization](/copy-page-button-showcase/docs/localization) :
